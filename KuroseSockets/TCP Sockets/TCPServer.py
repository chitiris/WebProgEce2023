...
# Ορισμός του διακομιστή να ακούει για μία εισερχόμενη σύνδεση, με έναν μέγιστο αριθμό 1 συνδέσεων στην ουρά αναμονής
...
while True:
    # Δέχεται μια σύνδεση από έναν πελάτη και παίρνει ένα νέο αντικείμενο socket για αυτήν τη σύνδεση
